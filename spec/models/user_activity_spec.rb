...
describe UserActivity do
  ...
  describe 'instance methods' do
    it 'user_name returns the full name of the user' do
      ...
      activity = vacation.activities.create!(price: 400.00, num_attendees: 2, description: "Sunset catamaran ride.", name: "Catamaran Tour", no_of_days: 1, cutoff_date: "2019-06-12", type: 2, user: user)
