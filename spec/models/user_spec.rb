...
describe User do
  ...
  describe 'class methods' do
    it '.check_for_existing_users' do
      ...
      miami = Vacation.create(name: "Family Reunion", city: "Miami", state: "FL", country: "US", latitude: 25.7617, longitude: 80.1918, start_date: 10.days.from_now, end_date: 15.days.from_now)
