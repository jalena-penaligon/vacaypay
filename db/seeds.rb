...
bachelorette = Vacation.create!(name: "Bachelorette", location: "Hawaii", start_date: "2019-06-12", end_date: "2019-06-15")
  ...
  boat_ride = bachelorette.activities.create!(price: 400.00, num_attendees: 2, description: "Sunset catamaran ride along the Napali Coast.", name: "Catamaran Tour", no_of_days: 1, cutoff_date: "2019-06-12", type: PerPersonCost, user_id: chi.id)
  ...
  atv_tour = bachelorette.activities.create!(price: 100.00, num_attendees: 1, description: "Let's go ATV'ing in the jungle.", name: "ATV Tour", no_of_days: 1, cutoff_date: "2019-06-12", type: PerPersonCost, user_id: chi.id)
